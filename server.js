/**
 * Thsi is going to be the starting point of the application
 */
...
async function init(){
    ...
    try{
        /**
         * Every time the server starts the collections should be refreshed
         */
...
require("./routes/user.route")(app); //this registers server with the route
