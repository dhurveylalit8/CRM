...
exports.createTicket = async (req, res) => {
     ...
     */
        ...
        /**
         * Find the engineer available and attach to the ticket ibject
         * 
         * Assignment : Extent this to choose the Engineer which has least number of tickets
         */
        ...
        if(ticketCreated){
             ...
             */
            sendNotificationReq(`Ticket created with id : ${ticketCreated._id}`, "Customer complaint ticket logged", `${customer.email}, ${engineer.email}, dhurvelalit8@gmail.com`, "CRM APP")
...
exports.getAllTickets = async (req, res) => {
    ...
    const queryObj = {};
    const ticketsCreated = user.ticketsCreated; // this is an array of the tickets _id
...
exports.updateTicket = async (req, res) => {
     ...
     */
        ...
        ticket.description = req.body.description != undefined ? re.body.description : ticket.description;
